...
$('document').ready(function(){
	...
	$('#dj_time').click(function(){
		...
		$('#b22').animate({top:240, left: vw-vw*3/4},500);
		$('#b33').animate({top:240, left: vw-vw*2/4},500);
		$('#b44').animate({top:240, left: vw-vw/4},500);
		$('#b55').animate({top:240, left: vw},500);
		$('#b66').animate({top:240, left: vw+vw/4},500);
		$('#b77').animate({top:240, left: vw+vw*2/4},500);
		$('#b88').animate({top:240, left: vw+vw*3/4},500);
		$('#b99').animate({top:240, left: vw+vw*9/10},500);
